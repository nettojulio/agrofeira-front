...
import {
  confirmarPagamento,
  obterPagamentoDetalhes,
  ComercianteDTO,
  RepasseDTO,
} from "@/services/repasses.service";
  ...
  useEffect(() => {
    const carregarDados = async () => {
      ...
      try {
        ...
        const dados = await obterPagamentoDetalhes(token, id);
            ...
            <div className="flex flex-col gap-6 sm:gap-8">
              ...
              >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <p className="text-sm sm:text-base text-[#4B5563] font-medium whitespace-pre-wrap">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(161deg, #F6FAF4 0%, #E8F5EC 100%)",
                  border: "1px solid #C2E5CC",
                }}
              >
                {/* Decoração de fundo */}
