                ...
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[#9db89f] text-xs">
                      {c.quantidade}x {formatarMoeda(c.valorUnitario)}
                    </p>
                  </div>
                </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[#8aaa8d] text-xs">
              Veja quais comerciantes oferecem cada item cadastrado
            </p>
          </div>
        </div>
            ...
            >
              ...
              <div className="text-center px-4">
                ...
                <p className="text-[#8aaa8d] text-[0.8rem] mt-1">
                  Selecione um item acima para ver os comerciantes que o
                  oferecem
                </p>
              </div>
            </div>
